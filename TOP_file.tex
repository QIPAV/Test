...
\hline 
        ...
        \textbf{Acceptance Criteria:}\cellcolor{gainsboro} & \multicolumn{4}{l|}{#6}  \\ [10pt] \hline
        \textbf{Verification Procedure:}\cellcolor{gainsboro} & \multicolumn{4}{l|}{#7} \\ [10pt] \hline
        \textbf{Result(s)/Report(s):}\cellcolor{gainsboro} & \multicolumn{4}{l|}{#8} \\ [10pt] \hline
        \textbf{Performed By:}\cellcolor{gainsboro} & \multicolumn{4}{l|}{#9} \\ [10pt]
        \hline
\end{tabularx}
\end{table}
\FloatBarrier}
...
0.2       & $21.01.17$   & Test Plan Document reorganized and  & VKH    & VKH          \\ 
          &              & new chapters are written.          &     &          \\
                                        \rowcolor{gainsboro}
0.3       & $23.01.17$   & Finished chapters  & VKH   & VKH\\
0.4       & $23.01.17$   & Some extra points on Testing Methods. & KSH   &VKH \\\rowcolor{gainsboro} 
0.5       & $24.01.17$   & Proof read and final edits/corrections & VKH  & VKH\\
...
\subfile{Sections/Test_Strategy}
\newpage

% CHAPTERs:
\subfile{Sections/Testing_Methods}
\newpage
