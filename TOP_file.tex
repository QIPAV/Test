...
\newcommand{\testcard}[9]{
\begin{table}[ht]
\begin{tabularx}{\linewidth}{| p{0.23\textwidth} p{0.16\textwidth} p{0.16\textwidth} p{0.16\textwidth} p{0.16\textwidth} |}
\hline 
        ...
        \textbf{Verification Method:}\cellcolor{gainsboro} & \multicolumn{4}{l|}{#7} \\ [10pt] \hline
